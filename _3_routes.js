...
var routes = (
	<Router>
		...
		<Route path='/' component={Main}>
			<Route path='/home' component={Home} />        // this is a 'child'
...
// because the Main route is always active and then the child that is activated is the one rendered within it as the props.children.
// React Router keeps track of which child route is active.